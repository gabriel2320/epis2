...
| PEND-006 | P1 | Impresión + piloto M3 | Ola 3 · receta A5 ✓ (+E2E en CI) · cert A5 ✓ (+E2E en CI) · **epicrisis Carta ✓ 2026-06-09** (`PrintLetterDocument` +E2E en CI · [reporte](./epis2-p1-print-discharge-letter-2026-06-09.md)) · m3-human-pilot **automatizado cerrado 2026-06-09** ([reporte](./epis2-m3-human-pilot-2026-06-09.md)) · resta otros A5 (órdenes lab/imagen) + signoff humano opcional |
