...
| **PROG-CONSOLIDATE** | ✓ ola 1 · **ola 2 activa** (MF-CON-02/04/05/06/07 ✓) | [`CONSOLIDATION_FREEZE.md`](CONSOLIDATION_FREEZE.md) · `tool:consolidate:verify-phase4` |
...
**Siguiente fase recomendada:** **PROG-CONSOLIDATE ola 2** — MF-CON-03 gobierno monorepo (PR 003). Leer [`CONSOLIDATION_FREEZE.md`](CONSOLIDATION_FREEZE.md). **No** features clínicas salvo MF autorizada.
