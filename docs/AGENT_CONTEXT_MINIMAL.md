...
| **PROG-CONSOLIDATE** | ✓ ola 1 · **ola 2 activa** (MF-CON-02…07/03/11 ✓) | [`CONSOLIDATION_FREEZE.md`](CONSOLIDATION_FREEZE.md) · `tool:consolidate:verify-phase4` |
...
**Siguiente fase recomendada:** **PROG-CONSOLIDATE ola 2** — MF-CON-09 fixtures o MF-CON-10 legal. Leer [`CONSOLIDATION_FREEZE.md`](CONSOLIDATION_FREEZE.md). **No** features clínicas salvo MF autorizada.
