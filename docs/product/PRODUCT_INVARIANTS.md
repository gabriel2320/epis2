...
| 6 | Home = Centro de Comando (`/comando`); estado inicial = búsqueda/censo paciente; workspace = ficha dual (ADR-002) | `command-center-home` + dual-chart census-gate |
...
- `docs/architecture/EPIS2_MODES_LAYER.md` — tres modos MD3 (secundarios; home = Centro de Comando)
