...
| `npm run openclaw:brief` | Brief read-only → `reports/archive/2026-06/openclaw-latest-brief.md` |
| `npm run openclaw:handoff` | Handoff post-revisión → `reports/archive/2026-06/openclaw-latest-handoff.md` |
