...
export const copy = {
  ...
  clinicalNav: {
    ...
    paper: 'Papel',
    more: 'Más',
    commandLegacy: 'Comando',
    boardSecondary: 'Tablero',
    alerts: 'Alertas',
    settings: 'Ajustes',
    ariaLabel: 'Navegación clínica',
  },
  uiSimplify: {
  ...
  dashboard: {
    ...
    gridColumnPending: 'Pendiente',
    gridColumnLastEvent: 'Última actividad',
    gridColumnDraftState: 'Borrador',
    gridColumnPrimaryAction: 'Acción',
  ...
  clinicalSummary: {
    ...
    classicBlocks: {
      ...
      lastEvolution: 'Última evolución',
      activeOrders: 'Indicaciones vigentes',
      relevantExams: 'Exámenes relevantes',
  ...
  patientSearch: {
    ...
    subtitle: 'Nombre, RUT, cama o diagnóstico',
    heroQuestion: '¿Qué paciente necesitas encontrar?',
    searchAction: 'Buscar',
    moreFilters: 'Más filtros',
    resultsHeading: 'Resultados',
    identifierLabel: 'RUT o identificador',
    identifierPlaceholder: 'Ej. DEMO-001',
  },
  forms: {
  ...
  censusShift: {
    ...
    riskNormal: 'Estable',
    riskWarning: 'Atención',
    riskCritical: 'Crítico simulado',
  },
  print: {
