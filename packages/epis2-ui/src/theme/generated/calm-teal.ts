/** GENERADO — no editar. Fuente: source/calm-teal.material-theme.json */
import type { Epis2MaterialColorScheme } from '../contracts/material-color-scheme.js';

export const calmTealLightScheme = {
  primary: '#006A6A',
  onPrimary: '#FFFFFF',
  primaryContainer: '#B2EBEB',
  ...
  inversePrimary: '#4FDAD8',
  scrim: '#000000',
  shadow: '#000000',
} as const satisfies Epis2MaterialColorScheme;

export const calmTealDarkScheme = {
  primary: '#4FDAD8',
  onPrimary: '#003737',
  primaryContainer: '#004F4F',
  onPrimaryContainer: '#B2EBEB',
  secondary: '#B0CCCB',
  onSecondary: '#1B3534',
