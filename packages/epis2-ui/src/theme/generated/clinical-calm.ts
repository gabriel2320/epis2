/** GENERADO — no editar. Fuente: source/clinical-calm.material-theme.json */
import type { Epis2MaterialColorScheme } from '../contracts/material-color-scheme.js';

export const clinicalCalmLightScheme = {
  primary: '#0B5C66',
  onPrimary: '#FFFFFF',
  primaryContainer: '#B8E8ED',
  onPrimaryContainer: '#003F48',
  secondary: '#4A5F63',
  onSecondary: '#FFFFFF',
  secondaryContainer: '#CCE7EB',
  onSecondaryContainer: '#32484C',
  tertiary: '#4B5F7C',
  onTertiary: '#FFFFFF',
  ...
  surface: '#F3FAFB',
  surfaceDim: '#D4DEE0',
  surfaceBright: '#F3FAFB',
  surfaceContainerLowest: '#FFFFFF',
  surfaceContainerLow: '#EEF5F6',
  ...
  inversePrimary: '#6BC4CF',
  scrim: '#000000',
  shadow: '#000000',
} as const satisfies Epis2MaterialColorScheme;

export const clinicalCalmDarkScheme = {
  primary: '#6BC4CF',
  onPrimary: '#00343A',
  primaryContainer: '#005662',
  onPrimaryContainer: '#B8E8ED',
  secondary: '#B0CBCF',
  onSecondary: '#1B3438',
  secondaryContainer: '#32484C',
