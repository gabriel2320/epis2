/** GENERADO — no editar. Fuente: source/monochrome-gray.material-theme.json */
import type { Epis2MaterialColorScheme } from '../contracts/material-color-scheme.js';

export const monochromeGrayLightScheme = {
  primary: '#171717',
  onPrimary: '#FFFFFF',
...
export const monochromeGrayDarkScheme = {
  primary: '#FAFAFA',
  onPrimary: '#171717',
