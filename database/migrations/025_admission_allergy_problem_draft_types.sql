-- MF-157…160: tipos de borrador ingreso, alergia y problema clínico.
...
UPDATE epis2_schema_meta SET version = 'epis2-admission-draft-types', applied_at = NOW() WHERE id = 1;
