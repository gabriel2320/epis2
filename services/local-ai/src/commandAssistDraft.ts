/** Intents de formulario borrador invocables con assist desde barra (MF-CM-06). */
...
/** Intent command-registry → blueprint assist. */
...
/** ¿Invocar assist tras resolver comando? Requiere IA disponible + intent borrador. */
export function shouldInvokeCommandAssistDraft(
  intent: string,
  aiAvailable: boolean,
): boolean {
