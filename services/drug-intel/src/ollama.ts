/**
 * Cliente Ollama mínimo para el pipeline drug-intel (capa dev/datos, no
 * producto). Sigue el patrón canónico de `services/local-ai/src/ollama.ts`:
 * JSON estructurado, timeout corto y degradación silenciosa — el pipeline
 * funciona completo sin Ollama (invariante 15).
 */
