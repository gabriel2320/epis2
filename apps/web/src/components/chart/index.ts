...
export {
  ...
  type ClinicalInstitutionalHeaderProps,
} from './ClinicalInstitutionalHeader.js';
export {
  PatientIdentityBand,
...
export {
  ...
  type TraditionalSectionNavProps,
} from './TraditionalSectionNav.js';
export {
  TraditionalClinicalPanel,
  type TraditionalClinicalPanelProps,
} from './TraditionalClinicalPanel.js';
export {
  ClinicalRightContextPanel,
  type ClinicalRightContextPanelProps,
} from './ClinicalRightContextPanel.js';
