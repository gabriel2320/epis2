...
export function fetchApsDashboard() {
  return apiFetch<ApsDashboardResponse>('/api/dashboard/aps');
}

export function fetchSpecialtyDashboard() {
  return apiFetch<SpecialtyDashboardResponse>('/api/dashboard/specialty');
}
