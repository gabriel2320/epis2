  ...
  return (
    ...
    <EpisAuthScreen>
      ...
      <Stack spacing={1} alignItems="center" textAlign="center">
        ...
        <EpisM3Text role="bodyMedium" color="text.secondary" component="p">
      ...
      <EpisM3Text role="bodyMedium" color="text.secondary" textAlign="center" component="p" sx={{ px: 1, lineHeight: 1.55 }}>
