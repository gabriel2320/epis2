...
function renderCommandCenter() {
  return renderWithEpisApp(<CommandCenterPage />);
}
...
vi.mock('../api/aiApi.js', () => ({
  fetchAiStatus: vi
    .fn()
    .mockResolvedValue({ available: false, ollama: 'down', localAi: 'down', message: '' }),
}));
...
describe('CommandCenterPage', () => {
  ...
  it('exige instrucción antes de continuar', async () => {
    ...
    await user.click(within(powerBar).getByRole('button', { name: copy.commandCenter.submit }));
