...
def test_readonly_user_cannot_write_patient(
    ...
    auth = auth_headers(client, email="lector@epis2.local", password="lector")
...
def test_readonly_user_can_read_patient_snapshot(
    ...
    readonly_auth = auth_headers(client, email="lector@epis2.local", password="lector")
