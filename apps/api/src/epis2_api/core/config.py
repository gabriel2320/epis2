...
DEFAULT_AUTH_SECRET = "epis2-local-dev-secret-change-me"
DEFAULT_AUTH_LOCAL_USERS = (
    "admin@epis2.local|admin|Administrador Dev|admin,dev;"
    "medico@epis2.local|medico|Medico Dev|medico;"
    "enfermeria@epis2.local|enfermeria|Enfermeria Dev|enfermeria;"
    "lector@epis2.local|lector|Lectura Dev|solo_lectura"
)
...
class Settings(BaseSettings):
    ...
    database_url: str = "postgresql+psycopg://epis2:epis2@localhost:5443/epis2"
