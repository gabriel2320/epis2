...
from epis2_api.schemas.ai import (
    AIProviderStatus,
    AiTaskStatus,
...
from epis2_api.schemas.patient import PatientRecordSnapshot
from epis2_api.services.ai.parsing import as_string_list, parse_json_content, parse_suggestions
from epis2_api.services.ai.snapshot import (
                ...
                "messages": [
                    {
                        "role": "system",
                        "content": (
                            "Eres un asistente local de documentacion clinica para EPIS2. "
