...
from epis2_api.api.deps import VitalSignActorDep
from epis2_api.models.clinical_record import VitalSign
from epis2_api.schemas.clinical_record import VitalSignCreate, VitalSignRead, VitalSignUpdate
