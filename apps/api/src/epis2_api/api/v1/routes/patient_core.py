...
from epis2_api.api.deps import AiAccessDep, PatientActorDep
from epis2_api.models.patient import Patient
from epis2_api.repositories import patients as patient_repo
from epis2_api.schemas.ai import PatientAiSuggestionRequest, PatientAiSuggestionsResponse
from epis2_api.schemas.patient import (
    PatientCreate,
    PatientRead,
    PatientRecordSnapshot,
    PatientUpdate,
)
from epis2_api.services.ai.provider import get_ai_provider
from epis2_api.services.audit import audit_snapshot, changed_field_snapshots, record_audit_event
