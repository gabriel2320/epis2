...
from epis2_api.api.deps import ClinicalEntryActorDep
from epis2_api.models.clinical_record import ClinicalEntry, ClinicalEntryStatus
from epis2_api.schemas.clinical_record import (
    ClinicalEntryCreate,
    ClinicalEntryRead,
    ClinicalEntryUpdate,
)
