...
from epis2_api.api.deps import AllergyActorDep
from epis2_api.models.clinical_record import Allergy, RecordStatus
from epis2_api.schemas.clinical_record import AllergyCreate, AllergyRead, AllergyUpdate
