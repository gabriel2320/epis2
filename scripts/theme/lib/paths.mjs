...
export const THEME_SOURCE_DIR = path.join(
  REPO_ROOT,
  'packages/epis2-ui/src/theme/source',
);
export const THEME_GENERATED_DIR = path.join(
  REPO_ROOT,
  'packages/epis2-ui/src/theme/generated',
);
