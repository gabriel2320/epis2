...
const OVERRIDES = {
  ...
  41: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'IcuDashboardTab MF-TRAMO-D-002' },
  42: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Sábana clínica demo MF-TRAMO-D-003' },
  43: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Balance hídrico demo MF-TRAMO-D-005' },
  44: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Ventilación demo MF-TRAMO-D-006' },
  45: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Vías invasivas demo MF-TRAMO-D-007' },
  46: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Valoración neurológica demo MF-TRAMO-D-009' },
  47: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Escalas severidad demo MF-TRAMO-D-010' },
  ...
  152: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Checklist OMS demo MF-TRAMO-E-003' },
  153: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Preanestesia demo MF-TRAMO-E-004' },
  154: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Anestesia intraop demo MF-TRAMO-E-005' },
  155: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Protocolo operatorio demo MF-TRAMO-E-006' },
  156: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Recuento compresas demo MF-TRAMO-E-007' },
  157: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Biopsia intraop demo MF-TRAMO-E-008' },
  158: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'URPA Aldrete demo MF-TRAMO-E-009' },
  159: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Banco sangre demo MF-TRAMO-E-010' },
  160: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Esterilización demo MF-TRAMO-E-011' },
  121: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'Control cardiovascular PSCV demo MF-TRAMO-F-002' },
  122: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'Framingham demo MF-TRAMO-F-003' },
  123: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'EMP tamizaje demo MF-TRAMO-F-004' },
  124: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'Pie diabético demo MF-TRAMO-F-005' },
  125: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'Salud mental demo MF-TRAMO-F-006' },
  126: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'Niño sano demo MF-TRAMO-F-007' },
  127: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'PNI demo MF-TRAMO-F-008' },
  128: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'Control prenatal demo MF-TRAMO-F-009' },
  129: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'MISSING', nota: 'Derivación ministerial demo MF-TRAMO-F-010' },
  135: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Hemodinámica demo MF-TRAMO-D-004 · specialized MF-TRAMO-G' },
  ...
  130: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Visita domiciliaria demo MF-TRAMO-F-011' },
  131: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'SBT demo MF-TRAMO-G-002' },
  132: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Terapias renales demo MF-TRAMO-G-003' },
  133: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'NPT demo MF-TRAMO-G-004' },
  134: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Nutrición enteral demo MF-TRAMO-G-005' },
  136: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Muerte encefálica demo MF-TRAMO-G-006' },
  137: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Procuramiento órganos demo MF-TRAMO-G-007' },
  138: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Diario UCI demo MF-TRAMO-G-008' },
  139: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Delirium CAM-ICU demo MF-TRAMO-G-009' },
  140: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Decúbito prono demo MF-TRAMO-G-010' },
  141: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Matriz vigilancia demo MF-TRAMO-H-002' },
  142: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Alerta MDRO demo MF-TRAMO-H-003' },
  143: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Consumo ATB demo MF-TRAMO-H-004' },
  144: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'PROA demo MF-TRAMO-H-005' },
  145: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Checklist CVC demo MF-TRAMO-H-006' },
  146: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Prevención NAV demo MF-TRAMO-H-007' },
  147: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Higiene manos demo MF-TRAMO-H-008' },
  148: { estado: 'Active', prioridad: 'High', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Estudio brote demo MF-TRAMO-H-009' },
  149: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Mapa aislamientos demo MF-TRAMO-H-010' },
  150: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Curvas endémicas demo MF-TRAMO-H-011' },
  181: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Partograma demo MF-TRAMO-I-002' },
  182: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Comité oncológico demo MF-TRAMO-I-003' },
  183: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Odontograma demo MF-TRAMO-I-004' },
  184: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Endoscopia demo MF-TRAMO-I-005' },
  185: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Oftalmología demo MF-TRAMO-I-006' },
  186: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Hemodiálisis demo MF-TRAMO-I-007' },
  187: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Kinesiología demo MF-TRAMO-I-008' },
  188: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Nutrición demo MF-TRAMO-I-009' },
  189: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Quimioterapia demo MF-TRAMO-I-010' },
  190: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Psiquiatría demo MF-TRAMO-I-011' },
  161: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Y-Site demo MF-TRAMO-J-002' },
  162: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Dosis renal demo MF-TRAMO-J-003' },
  163: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'TDM demo MF-TRAMO-J-004' },
  164: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'RAM demo MF-TRAMO-J-005' },
  165: { estado: 'Done', prioridad: 'High', horizonte: 'Core', decision: 'Build', legacy: 'COMPLETE', nota: 'Conciliación COMPLETE · panel MF-TRAMO-J-006' },
  166: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Dispensación demo MF-TRAMO-J-007' },
  167: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Carro paro demo MF-TRAMO-J-008' },
  168: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Estupefacientes demo MF-TRAMO-J-009' },
  169: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Devolución demo MF-TRAMO-J-010' },
  170: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Quiebre stock demo MF-TRAMO-J-011' },
  171: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Centinela demo MF-TRAMO-K-002' },
  172: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'ACR demo MF-TRAMO-K-003' },
  173: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Comité mortalidad demo MF-TRAMO-K-004' },
  174: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Auditoría registros demo MF-TRAMO-K-005' },
  175: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'OIRS demo MF-TRAMO-K-006' },
  176: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Clima laboral demo MF-TRAMO-K-007' },
  177: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Consentimientos demo MF-TRAMO-K-008' },
  178: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Acreditación demo MF-TRAMO-K-009' },
  179: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Docs institucionales demo MF-TRAMO-K-010' },
  180: { estado: 'Active', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Build', legacy: 'PARTIAL', nota: 'Suspensión Qx demo MF-TRAMO-K-011' },
