...
const OVERRIDES = {
  ...
  2: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-B-002 ReceptionDashboardTab + E2E',
  },
  3: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-B-002 agenda en tablero recepción',
  },
  4: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-B-002 calendario demo recepción',
  },
  5: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-B-002 admisión admin panel (≠ admission_note)',
  },
  6: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'MF-TRAMO-B-002 biometría Tramo B+',
  },
  7: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-B-002 sala espera virtual demo',
  },
  8: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-B-002 sobrecupos métrica demo',
  },
  9: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-B-002 acompañantes métrica demo',
  },
  10: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Integrate',
    legacy: 'MISSING',
    nota: 'MF-TRAMO-B-002 panel llamado demo; IoT Future',
  },
  ...
  101: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-C-002 EmergencyDashboardTab triaje demo',
  },
  41: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'IcuDashboardTab MF-TRAMO-D-002',
  },
  42: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Sábana clínica demo MF-TRAMO-D-003',
  },
  43: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Balance hídrico demo MF-TRAMO-D-005',
  },
  44: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Ventilación demo MF-TRAMO-D-006',
  },
  45: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Vías invasivas demo MF-TRAMO-D-007',
  },
  46: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Valoración neurológica demo MF-TRAMO-D-009',
  },
  47: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Escalas severidad demo MF-TRAMO-D-010',
  },
  48: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Titulación vasoactivos demo MF-TRAMO-D-011',
  },
  49: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Sedoanalgesia demo MF-TRAMO-D-012',
  },
  50: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Epicrisis traslado UCI MF-TRAMO-D-008',
  },
  151: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'OrDashboardTab MF-TRAMO-E-002',
  },
  152: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Checklist OMS demo MF-TRAMO-E-003',
  },
  153: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Preanestesia demo MF-TRAMO-E-004',
  },
  154: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Anestesia intraop demo MF-TRAMO-E-005',
  },
  155: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Protocolo operatorio demo MF-TRAMO-E-006',
  },
  156: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Recuento compresas demo MF-TRAMO-E-007',
  },
  157: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Biopsia intraop demo MF-TRAMO-E-008',
  },
  158: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'URPA Aldrete demo MF-TRAMO-E-009',
  },
  159: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Banco sangre demo MF-TRAMO-E-010',
  },
  160: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Esterilización demo MF-TRAMO-E-011',
  },
  121: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'Control cardiovascular PSCV demo MF-TRAMO-F-002',
  },
  122: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'Framingham demo MF-TRAMO-F-003',
  },
  123: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'EMP tamizaje demo MF-TRAMO-F-004',
  },
  124: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'Pie diabético demo MF-TRAMO-F-005',
  },
  125: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'Salud mental demo MF-TRAMO-F-006',
  },
  126: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'Niño sano demo MF-TRAMO-F-007',
  },
  127: {
    estado: 'Active',
    prioridad: 'Medium',
  ...
  128: {
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'Control prenatal demo MF-TRAMO-F-009',
  },
  129: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'MISSING',
    nota: 'Derivación ministerial demo MF-TRAMO-F-010',
  },
  135: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Hemodinámica demo MF-TRAMO-D-004 · specialized MF-TRAMO-G',
  },
  102: {
    estado: 'Active',
    prioridad: 'Critical',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-C-002 workspace emergency',
  },
  103: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-C-002 panel reanimación demo',
  },
  104: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-C-002 trauma FAST demo',
  },
  105: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-C-002 observación corta demo',
  },
  21: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'PatientWorkspacePage hub M3 + E2E MF-OLA3-006',
  },
  22: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'ClinicalAlertsPanel ficha + E2E DEMO-005 MF-OLA3-003',
  },
  23: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'timeline ficha + E2E DEMO-001 MF-OLA3-005',
  },
  24: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'medicamentos activos ficha MF-OLA3-005',
  },
  25: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'LabObservationsGrid + CTA resultados MF-OLA3-005',
  },
  26: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'PatientClinicalCharts DEMO-005 MF-OLA3-005',
  },
  27: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'allergy_entry + E2E ficha MF-OLA3-004',
  },
  28: {
    estado: 'Done',
    prioridad: 'High',
  ...
  29: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'clinical_problem_entry + E2E ficha MF-OLA3-004',
  },
  30: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'problemCategory + sección Ant.Qx MF-OLA3-007',
  },
  31: {
    estado: 'Done',
    prioridad: 'Critical',
    ...
    decision: 'Build',
    legacy: 'COMPLETE',
    nota: 'outpatient_visit anamnesis — MF-OLA2-001',
  },
  32: {
    estado: 'Done',
    prioridad: 'High',
  ...
  33: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'physical-general accordion + E2E MF-OLA2-003',
  },
  34: {
    estado: 'Done',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'physical-segment accordion MF-OLA2-003',
  },
  35: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'icd10Code diagnosis section MF-OLA2-003',
  },
  36: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'COMPLETE',
    nota: 'plan + indicaciones generales',
  },
  37: {
    estado: 'Done',
    prioridad: 'Critical',
  ...
  38: {
    ...
    decision: 'Defer',
    legacy: 'PARTIAL',
    nota: 'MF-TRAMO-A-CLOSURE — macros EPIS diferidas; consulta usa textarea libre',
  },
  39: {
    estado: 'Done',
    prioridad: 'Critical',
    ...
    decision: 'Build',
    legacy: 'COMPLETE',
    nota: 'closeEncounter + FAB cierre Ola 2',
  },
  40: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'PrintA5 + E2E MF-OLA6A-002 — vista documental (no firma auto)',
  },
  51: {
    estado: 'Active',
    prioridad: 'High',
  ...
  56: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'imaging_request + journey MF-OLA1C-003',
  },
  58: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'COMPLETE',
    nota: 'ResultsInboxPage + tendencias MF-TRAMO-C-005 + journey MF-OLA1C-001',
  },
  59: {
    estado: 'Planned',
    prioridad: 'Medium',
  ...
  62: {
    ...
    decision: 'Build',
    legacy: 'COMPLETE',
    nota: 'medical_certificate Ola 2 + print A5',
  },
  69: {
    estado: 'Active',
    prioridad: 'Medium',
  ...
  95: {
    ...
    decision: 'Exclude',
    legacy: 'MISSING',
    nota: 'No auto-diagnóstico (invariante)',
  },
  97: {
    estado: 'Active',
    prioridad: 'Medium',
  ...
  110: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'CTA epicrisis tablero urgencias MF-TRAMO-C-006',
  },
  111: {
    estado: 'Done',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'nursing_note + CTA ficha MF-TRAMO-C-003',
  },
  116: {
    estado: 'Done',
    prioridad: 'Critical',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'MAR tablero + /espacio/mar MF-TRAMO-C-008',
  },
  120: {
    estado: 'Active',
    prioridad: 'Medium',
  ...
  130: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Visita domiciliaria demo MF-TRAMO-F-011',
  },
  131: {
    estado: 'Active',
    prioridad: 'High',
  ...
  132: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Terapias renales demo MF-TRAMO-G-003',
  },
  133: {
    estado: 'Active',
    prioridad: 'High',
  ...
  134: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Nutrición enteral demo MF-TRAMO-G-005',
  },
  136: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Muerte encefálica demo MF-TRAMO-G-006',
  },
  137: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Procuramiento órganos demo MF-TRAMO-G-007',
  },
  138: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Diario UCI demo MF-TRAMO-G-008',
  },
  139: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Delirium CAM-ICU demo MF-TRAMO-G-009',
  },
  140: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Decúbito prono demo MF-TRAMO-G-010',
  },
  141: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Matriz vigilancia demo MF-TRAMO-H-002',
  },
  142: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Alerta MDRO demo MF-TRAMO-H-003',
  },
  143: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Consumo ATB demo MF-TRAMO-H-004',
  },
  144: {
    estado: 'Active',
    prioridad: 'High',
  ...
  145: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Checklist CVC demo MF-TRAMO-H-006',
  },
  146: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Prevención NAV demo MF-TRAMO-H-007',
  },
  147: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Higiene manos demo MF-TRAMO-H-008',
  },
  148: {
    estado: 'Active',
    prioridad: 'High',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Estudio brote demo MF-TRAMO-H-009',
  },
  149: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Mapa aislamientos demo MF-TRAMO-H-010',
  },
  150: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Curvas endémicas demo MF-TRAMO-H-011',
  },
  181: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Partograma demo MF-TRAMO-I-002',
  },
  182: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Comité oncológico demo MF-TRAMO-I-003',
  },
  183: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Odontograma demo MF-TRAMO-I-004',
  },
  184: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Endoscopia demo MF-TRAMO-I-005',
  },
  185: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Oftalmología demo MF-TRAMO-I-006',
  },
  186: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Hemodiálisis demo MF-TRAMO-I-007',
  },
  187: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Kinesiología demo MF-TRAMO-I-008',
  },
  188: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Nutrición demo MF-TRAMO-I-009',
  },
  189: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Quimioterapia demo MF-TRAMO-I-010',
  },
  190: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Psiquiatría demo MF-TRAMO-I-011',
  },
  161: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Y-Site demo MF-TRAMO-J-002',
  },
  162: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Dosis renal demo MF-TRAMO-J-003',
  },
  163: {
    estado: 'Active',
    prioridad: 'Medium',
  ...
  165: {
    ...
    decision: 'Build',
    legacy: 'COMPLETE',
    nota: 'Conciliación COMPLETE · panel MF-TRAMO-J-006',
  },
  166: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Dispensación demo MF-TRAMO-J-007',
  },
  167: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Carro paro demo MF-TRAMO-J-008',
  },
  168: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Estupefacientes demo MF-TRAMO-J-009',
  },
  169: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Devolución demo MF-TRAMO-J-010',
  },
  170: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Quiebre stock demo MF-TRAMO-J-011',
  },
  171: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Centinela demo MF-TRAMO-K-002',
  },
  172: {
    estado: 'Active',
    prioridad: 'Medium',
  ...
  173: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Comité mortalidad demo MF-TRAMO-K-004',
  },
  174: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Auditoría registros demo MF-TRAMO-K-005',
  },
  175: {
    estado: 'Active',
    prioridad: 'Medium',
  ...
  176: {
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Clima laboral demo MF-TRAMO-K-007',
  },
  177: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Consentimientos demo MF-TRAMO-K-008',
  },
  178: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Acreditación demo MF-TRAMO-K-009',
  },
  179: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Docs institucionales demo MF-TRAMO-K-010',
  },
  180: {
    estado: 'Active',
    prioridad: 'Medium',
    ...
    decision: 'Build',
    legacy: 'PARTIAL',
    nota: 'Suspensión Qx demo MF-TRAMO-K-011',
  },
  191: {
    estado: 'Active',
    prioridad: 'Low',
  ...
  98: {
    ...
    decision: 'Exclude',
    legacy: 'MISSING',
    nota: 'Fuera alcance clínico MVP',
  },
};
...
const RANGE_DEFAULTS = [
  ...
  },
  {
    ...
    fields: {
      ...
      decision: 'Defer',
      legacy: 'DEFERRED',
      nota: 'UCI Tramo D; duplica 131–140',
    },
  },
  {
    from: 53,
  ...
  },
  {
    ...
    fields: {
      ...
      decision: 'Build',
      legacy: 'MISSING',
      nota: 'Workspace emergency Tramo C',
    },
  },
  {
    from: 107,
  ...
  },
  {
    ...
    fields: {
      ...
      decision: 'Defer',
      legacy: 'MISSING',
      nota: 'Programas APS ministeriales',
    },
  },
  {
    from: 131,
    ...
    fields: {
      ...
      decision: 'Defer',
      legacy: 'DEFERRED',
      nota: 'UCI especializada Tramo D',
    },
  },
  {
    from: 141,
...
const stats = {
  ...
  totals: {
    estado: Object.fromEntries(
      ESTADOS.map((k) => [k, matrix.filter((r) => r.estado === k).length]),
    ),
    prioridad: Object.fromEntries(
      PRIORIDADES.map((k) => [k, matrix.filter((r) => r.prioridad === k).length]),
    ),
    horizonte: Object.fromEntries(
      HORIZONTES.map((k) => [k, matrix.filter((r) => r.horizonte === k).length]),
    ),
    decision: Object.fromEntries(
      DECISIONES.map((k) => [k, matrix.filter((r) => r.decision === k).length]),
    ),
  },
};
