...
const OVERRIDES = {
  ...
  33: { estado: 'Active', prioridad: 'High', horizonte: 'Core', decision: 'Build', legacy: 'PARTIAL', nota: 'examen general accordion — plantillas pendientes' },
  34: { estado: 'Active', prioridad: 'Medium', horizonte: 'Core', decision: 'Build', legacy: 'PARTIAL', nota: 'examen segmentario accordion' },
  35: { estado: 'Active', prioridad: 'High', horizonte: 'Core', decision: 'Build', legacy: 'PARTIAL', nota: 'CIE-10 demo staging' },
  ...
  10: { estado: 'Planned', prioridad: 'Medium', horizonte: 'Post-core', decision: 'Integrate', legacy: 'MISSING', nota: 'Display externo IoT' },
