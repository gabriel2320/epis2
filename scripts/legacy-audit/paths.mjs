...
export const FORBIDDEN_PATTERNS = [
  ...
  {
    id: 'carbon-dep',
    re: /@carbon\b|carbon-components/i,
    severity: 'critical',
    label: 'Dependencia Carbon',
  },
  { id: 'openmrs-path', re: /openmrs[\\/]/i, severity: 'warning', label: 'Ruta openmrs/' },
  {
    ...
    re: /\/home\/epis-/i,
    severity: 'warning',
    label: 'Ruta legacy /home/epis-*',
  },
  {
    id: 'wildcard-perm',
    re: /permission[s]?\s*[:=]\s*['"]\*['"]/i,
    severity: 'high',
    label: 'Permiso wildcard',
  },
  {
    id: 'auto-approve',
    re: /autoApprove|auto_approve|firma\s*autom/i,
    severity: 'high',
    label: 'Aprobación/firma automática',
  },
];
...
export const SECRET_PATTERNS = [
  ...
  {
    id: 'password-assign',
    re: /(password|passwd|secret|api[_-]?key)\s*=\s*['"][^'"]{8,}['"]/i,
    severity: 'high',
  },
];
...
export const PHI_HINT_PATTERNS = [
  {
    id: 'rut-real-looking',
    re: /\b[12]\d{3}\.\d{3}\.\d{3}-[\dkK]\b/,
    severity: 'medium',
    label: 'RUT con formato real',
  },
];
